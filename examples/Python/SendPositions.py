...
MotorA.send_message(DriverComms.SetU32(Messages.MessageTypes.SetAcceleration, 64*300))
MotorA.send_message(DriverComms.SetU32(Messages.MessageTypes.SetMaxSpeed, 64*200))
time.sleep(0.1)
move(MotorA, -365*2)
time.sleep(0.1)
