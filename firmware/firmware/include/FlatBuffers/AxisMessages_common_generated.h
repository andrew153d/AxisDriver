...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) HeaderStruct FLATBUFFERS_FINAL_CLASS {
 private:
 ...
 public:
  ...
  HeaderStruct(uint32_t _sync_bytes, uint16_t _message_type, uint16_t _body_size)
      : sync_bytes_(::flatbuffers::EndianScalar(_sync_bytes)),
        message_type_(::flatbuffers::EndianScalar(_message_type)),
        body_size_(::flatbuffers::EndianScalar(_body_size)) {
  }
  uint32_t sync_bytes() const {
    return ::flatbuffers::EndianScalar(sync_bytes_);
  }
  uint16_t message_type() const {
    return ::flatbuffers::EndianScalar(message_type_);
  }
  uint16_t body_size() const {
    return ::flatbuffers::EndianScalar(body_size_);
  }
};
FLATBUFFERS_STRUCT_END(HeaderStruct, 8);
...
struct Header FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const AxisDriver::Header *header() const {
    return GetPointer<const AxisDriver::Header *>(VT_HEADER);
  }
...
struct HeaderBuilder {
  ...
  void add_header(::flatbuffers::Offset<AxisDriver::Header> header) {
    fbb_.AddOffset(Header::VT_HEADER, header);
  }
...
inline ::flatbuffers::Offset<Header> CreateHeader(
    ...
    ::flatbuffers::Offset<AxisDriver::Header> header = 0) {
